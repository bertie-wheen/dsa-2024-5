...
import dsa.lab11.solutions.TopologicalSorter;
...
public class DAGRelaxer
{
    ...
    Edge<Vertex, Double> edge)
  {
    ...
    // TODO: Implement DAGRelaxer.relax(Map paths, Edge edge)
    ...
    // NOTE: Update the paths map to contain this newly-found path if better
    //       (or if at least as good, i.e. at least as short).
  }
